...
public class PessoaTest {
    ...
    // INSTANCIAR PESSOA - EXECUTAR ANTES DE CADA TESTE
    @BeforeEach
    void doBefore(){
    ...
    @Test
    // IMPLEMENTANDO O QUE ESTÁ SE TESTANDO
        // assertEquals compara se os dois lados estão iguais pessoa/calcularNome
    ...
    // TESTANDO O MÉTODO QUE RETORNA UMA LISTA DE PESSOA
    @Test
    void getListaPessoas(){
        // instancia separada:
        Pessoa pessoaTest = new Pessoa("Teste");
        assertEquals(2,pessoaTest.verificarPessoa(pessoas).size());
    }
/*
    // TESTE SE A IDADE ESTÁ PREENCHIDA
    void getIdadePreenchidaFalse (){
        pessoa.setIdade(null);
        assertFalse(new Object);
    }
