...
public class ProfessorEntity {
    ...
    private Set<AlunoEntity> alunos = new HashSet<>(); //CASO QUEIRA TRAZER OS ALUNOS ATRAVES DE PROF. BUSCAR O PROF E
    // MOSTRAR TODOS OS ALUNOS DESTE. O 'SET' NÃO PERMITE DADOS REPETIDOS NA LISTA
