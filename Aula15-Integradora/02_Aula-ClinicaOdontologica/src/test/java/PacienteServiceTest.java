...
public class PacienteServiceTest {
    ...
    @BeforeAll
    public static void carrgearTabela(){
    ...
    public void salvarPacienteEBuscar(){
        Endereco endereco3 = new Endereco("Av Vieira Souto", "123", "Rio de Janeiro", "Rio de Janeiro");
        Paciente p3 = pacienteService.salvar(new Paciente("Thomas", "Pereira",
